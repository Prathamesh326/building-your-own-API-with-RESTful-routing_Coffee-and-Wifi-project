...
def get_cafe_at_location():
    ...
    res = db.session.execute(db.select(Cafe).where(Cafe.location == query_location))
...
def add_new_cafe():
    ...
    if api_key == "TopSecretAPIKey":
        new_cafe = Cafe(
            ...
            can_take_calls=bool(request.form.get("take_calls")),
...
def update_cafe(cafe_id):
    ...
    cafe_data = db.session.get(Cafe, cafe_id)
    print(cafe_data)
    if cafe_data:
